<%--<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="测试.aspx.cs" Inherits="资产管理.测试2" %>

<!DOCTYPE html>
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>科技文件管理系统</title>
    ...
    <style>
        * {
        ...
        .btn-export {
            background: linear-gradient(90deg, #6a008c, #9d00c8);
        }
        ...
        .btn-export:hover {
            box-shadow: 0 6px 20px rgba(180, 80, 230, 0.5);
        }
            ...
            <div class="card">
                ...
                <div class="upload-section">
                    ...
                    <asp:Button ID="UploadButton" runat="server" Text="上传文件" 
                        OnClick="UploadButton_Click" CssClass="btn" OnClientClick="startProgress()" />
                </div>
